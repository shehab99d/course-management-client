...
const Navbar = () => {
  ...
  const navLinkClass = ({ isActive }) =>
    isActive
      ? "text-purple-600 font-semibold border-2 border-purple-500"
    ...
    <div className="navbar bg-base-100 shadow-md px-4 sticky top-0 z-50">
      ...
      <div className="navbar-end gap-2">
        {user ? (
          ...
          <>
            <NavLink to="/login" className="btn btn-sm btn-outline hover:btn-primary transition duration-200">
              Login
            </NavLink>
            <NavLink to="/register" className="btn btn-sm bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:scale-105 transition">
              Register
            </NavLink>
          </>
        )}
